...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://arbuz.ai"
  },
  openGraph: {
    title: "Arbuz AI - AI Platform for Performance Creatives & PWAs",
    description: "Generate high-converting banners and PWAs in 3-5 minutes. Powered by AI. No designer needed.",
    url: "https://arbuz.ai",
    siteName: "Arbuz AI",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763731779989-4qienovj.jpg",
        alt: "Arbuz AI Platform"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Arbuz AI - Generate Banners & PWAs Instantly",
    description: "Create professional marketing creatives in minutes with AI",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763731779989-4qienovj.jpg"]
  },
  robots: {
    index: true,
    follow: true
